...
public class Q46_Get_First_And_Get_Last_In_Doubly_Linked_List{
    public static class DoublyLinkedList {
        ...
        // size variable contains the size of actual linked list
        public int size() {
          return this.size;
        }
    
        // if this.size == 0 is true then it'll return true else return false
        ...
        // if ListIsEmptyException() is true then print "ListIsEmpty: -1"
        // else return data of head and in last node return data of tail
        public int getFirst() {
