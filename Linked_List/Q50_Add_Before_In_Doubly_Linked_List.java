...
public class Q50_Add_Before_In_Doubly_Linked_List {
    public static class DoublyLinkedList {
        ...
        public void addBefore(Node ref, Node node){
            // ref node is the node before that node we want to add node
            // so check the prev of that node
            // if prev is null that means ref is head
            // so next of node will point to ref and prev of ref will point to node
            ...
            if(prev == null){
                ...
                // else prev next will point to node
                // node prev point to prev
                // node next point to ref
                // ref prev point to node
                // and size will be increamented by one
