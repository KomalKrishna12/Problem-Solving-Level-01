import java.io.*;
import java.util.*;
public class Q12_Linearize_efficent_Approach {
    ...
    public static void linearize(Node node) {
        ...
        // we assume that node.children is linearized and we just need to linear node
        // with its
        // children suppose node is 10 its child are 20 30 40 which linearize so
        // 20-50-60 30-70 40-80-90
