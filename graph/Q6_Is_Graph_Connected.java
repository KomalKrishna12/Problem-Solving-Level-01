import java.io.*;
import java.util.*;
// graph connected means any of vertex we can go till end
// if graph is connected then only one component will be created
public class Q6_Is_Graph_Connected {
    static class Edge {
        int src;
        int nbr;
        int wt;
      ...
      public static void main(String[] args) throws Exception {
        ...
        // now check comps size if it 1 then it is connected otherwise not
